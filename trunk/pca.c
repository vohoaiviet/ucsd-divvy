...
void reduce_data(float* X, int D, int N, float* Y, int no_dims) {
	...
	cblas_sgemm(CblasRowMajor, CblasNoTrans, CblasTrans, D, D, N, 1.0, X, N, X, N, 1.0, C, D);*/
	...
	//cblas_sgemm(CblasRowMajor, CblasTrans, CblasNoTrans, no_dims, N, D, 1.0, C, D, X, N, 1.0, Y, N);
